...
class H60Driver extends Homey.Driver {
  ...
  registerFlows() {
    ...
    // Sub capability triggers we want that are not auto generated by Homey
    // Additionally triggers that do not follow the capability + "_changed" suffix convention
